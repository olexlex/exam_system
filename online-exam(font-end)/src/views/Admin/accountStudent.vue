<template>
  ...
  <div >
    ...
    <el-col :span="6">
      <el-input v-model="ManagerInfo.name" placeholder="请输入学生账号"></el-input>
    </el-col>
    <el-col :span="16">      
       <el-button type="success" round class='search_btn' @click="search_manager">查找学生</el-button>
...
methods: {
  ...
  this.$axios.get('/user/list/type/2')
  .then((response) =>{
