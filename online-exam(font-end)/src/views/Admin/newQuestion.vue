  ...
  <div class="add">
      <section class="append">
        ...
        <div class="change" v-if="optionValue == '多选题'">
          ...
          <div class="submit">
            <el-button type="primary" @click="change2Submit()">立即添加</el-button>
          </div>
        </div>
        <!-- 判断题 -->
 ...
 data() {
  ...
  methods:{
   ...
   change2Submit(){
    ...
    judgeSubmit(){
  if(this.postJudge.question===''||this.postJudge.answer===''||this.postJudge.section==='')
      {
         this.$message({
                      message:'题干和正确答案以及对应专业不能为空!',
                      type:'error'
    ...
    fillSubmit(){
  if(this.postShortAnswer.question===''||this.postShortAnswer.answer===''||this.postShortAnswer.section==='')
      {
         this.$message({
                      message:'题干和正确答案以及对应专业不能为空!',
                      type:'error'
              ...
              if(response.data.errno===0){
                for(let i=0;i< response.data.data.length;i++)
                {
                  ...
                  if(value.name===this.postShortAnswer.section)
                  {
                    ...
                    this.$axios.post('/quest',{
                    answer:this.postShortAnswer.answer,
